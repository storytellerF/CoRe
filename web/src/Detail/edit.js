    ...
    useEffect(() => {
        return runWithLifecycle((state) => {
            ...
            if (content.startsWith(marpMark)) {
                ...
                if (!state.canceled)
                    updateRender(`<div class="marpit">${o}</div>`);
            } else {
    ...
    return (
        <div className="container" style={{ marginTop: "20px" }}>
            <form id="save-core" onSubmit={handleSubmit}>
                ...
                />
                <div className="mb-3">
                    <label htmlFor="core-title" className="form-label">
                        标题
                    </label>
                    <input
                        type="text"
                ...
                <div className="row" id="input-group">
                    <div className="col-md-6">
                        <label htmlFor="core-content" className="form-label">
                            内容
                        </label>
                        <textarea
                            name="codeContent"
